...
## Objective:
  - Analyze the various different types of wines, where they were made, the winery, the taster, etc. and see if we can find trends with location, taster, type of wine, the rated points by the sommolier, and price
  
Inspiration:
  - With all of these attributes, are we able to confidently predict a cost of wine based on these various attributes?
...
## Machine Learning: 
 Data Pre-processing
  ...
  ![](Pages/Country_vs_Price.png)
  ![](Pages/Points_vs_Price.png)
  ![](Pages/Taster_vs_Price.png)
  ![](Pages/Region_vs_Price.png)
